      ...
      <head>
        <Script id="fl-consent-config" strategy="beforeInteractive">{`
          window.FLConsentConfig = {
            appId: "vibereader",
            appName: "VibeReader",
            cookieName: "fl_consent_vibereader",
            bannerText: "VibeReader uses necessary storage to remember this choice. With your permission, it also uses Amplitude analytics and session replay to understand how the app is used. Analytics is optional — you can decline and still use the app.",
            theme: "dark"
          };
        `}</Script>
        <Script
